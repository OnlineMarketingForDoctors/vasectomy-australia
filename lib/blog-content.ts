/**
 * Full-length blog articles authored in code, then seeded into Sanity as `post`
 * documents (with portable-text bodies) via /api/seed-posts. Once seeded they
 * are editable in the Studio like any other post.
 */
export type RichBlogPost = {
  slug: string;
  title: string;
  seoTitle: string;
...
export const richBlogPosts: RichBlogPost[] = [
  {
    slug: "is-a-vasectomy-reversible",
    title: "Is a Vasectomy Reversible? Success Rates, Facts & What to Expect",
    seoTitle: "Are Vasectomies Reversible? Facts, Success & Outcomes",
    seoDescription:
      "Vasectomy reversals explained: procedure details, success factors, and why vasectomy should be seen as a permanent choice.",
    excerpt:
      "Vasectomy reversals explained — how the procedure works, what affects success rates, and why a vasectomy should be seen as a permanent choice.",
    category: "Education",
    publishedAt: "2026-07-06T00:00:00.000Z",
    coverUrl:
      "https://d2ol7oe51mr4n9.cloudfront.net/user_3Ary2g06ZSWzxFoVWIP644Wm9ZG/69a6f45c-75d1-4705-b585-718dcb429281.png",
    coverAlt:
      "A doctor explaining male fertility and vasectomy reversal to a patient",
    bodyMarkdown: `## Understanding the Realities of Vasectomy Reversal
...
Vasectomy is designed to be permanent and reversal is not always a guaranteed solution.

## Common Reasons Men Consider Reversal

While most men who choose to have a vasectomy are certain about their decision, some may experience a change in circumstances later in life. Common reasons for seeking a vasectomy reversal include:

...
import { getDoctors, type SiteDoctor } from "@/lib/site-data";
...
function Profile({ doctor, flip }: { doctor: SiteDoctor; flip: boolean }) {
  return (
      ...
      <div className={`lg:col-span-6 ${flip ? "lg:order-1 lg:col-start-1" : "lg:col-start-7"}`}>
        <Reveal>
          ...
          <div className="mt-6 space-y-4 leading-relaxed text-ink-soft">
            ...
            {doctor.personal ? <p className="text-ink">{doctor.personal}</p> : null}
          </div>
